...
export const EventSeriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBatch: async (getEventSeriesDto: GetEventSeriesDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'getEventSeriesDto' is not null or undefined
            assertParamExists('getBatch', 'getEventSeriesDto', getEventSeriesDto)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(getEventSeriesDto, localVarRequestOptions, configuration)
...
export const EventSeriesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBatch(getEventSeriesDto: GetEventSeriesDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<EventSeriesDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBatch(getEventSeriesDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EventSeriesApi.getBatch']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns event instances belonging to this series, ordered by start time. Defaults to only ongoing/upcoming instances.
...
export class EventSeriesApi extends BaseAPI implements EventSeriesApiInterface {
     ...
     * @throws {RequiredError}
     */
    public getBatch(getEventSeriesDto: GetEventSeriesDto, options?: RawAxiosRequestConfig) {
        return EventSeriesApiFp(this.configuration).getBatch(getEventSeriesDto, options).then((request) => request(this.axios, this.basePath));
    }
